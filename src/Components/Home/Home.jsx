...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setTopButton(window.scrollY > 150);
    };
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white relative selection:bg-teal-400 selection:text-black">
      ...
      <FooterReveal footer={<SpecialFooter />}>
        <main>
          <section
            id="home"
            aria-label="Hero"
          ...
          >
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center px-4 sm:px-8 text-center max-w-6xl mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-10">
                <Magnetic strength={0.4}>
                  <button
                    ...
                    className="min-h-[46px] px-6 py-2.5 rounded-full bg-teal-400 hover:bg-white text-black font-semibold font-neue text-sm sm:text-base transition-colors flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none shadow-lg shadow-teal-500/20"
                  >
                ...
                <Magnetic strength={0.4}>
                  <button
                    ...
                    className="min-h-[46px] px-6 py-2.5 rounded-full bg-zinc-900/80 hover:bg-zinc-800 text-zinc-200 hover:text-white border border-zinc-700 font-neue text-sm sm:text-base transition-colors focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none"
                  >
                    Get in Touch
                  </button>
                </Magnetic>
                ...
                <Magnetic strength={0.4}>
                  <button
                    ...
                    className="min-h-[46px] px-5 py-2.5 rounded-full bg-zinc-900/60 hover:bg-zinc-800 text-zinc-300 hover:text-white border border-zinc-800 font-neue text-sm sm:text-base transition-colors flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none"
              ...
              {/* 
              <Reveal
                className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mt-12 sm:mt-16 w-full max-w-3xl"
                stagger={0.12}
                y={30}
                start="top 92%"
              >
          ...
          >
            ...
            <Reveal
              ...
              stagger={0.15}
            >
              <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex flex-col gap-5">
                <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 flex flex-col text-left">
                  ...
                  <p className="font-neue text-sm sm:text-base text-zinc-300 leading-relaxed mb-6">
                    ...
                    modern, high-performance web applications. With hands-on
                    experience in building scalable user interfaces using React,
                    Next.js, and TypeScript, I translate intricate designs into
                    responsive, accessible, and fluid user experiences. I thrive
                    on solving complex frontend challenges and collaborating in
          ...
          {/* Pinned scroll-storytelling: must not sit inside a transformed
              ancestor, or ScrollTrigger's fixed pinning breaks. */}
          ...
          >
            <Reveal className="mb-8 px-2" y={30}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-brolimo font-semibold text-white">
                Featured Projects<span className="text-teal-400">.</span>
              </h2>
            </Reveal>
            {/* Projects owns a sticky horizontal carousel — no Reveal wrapper,
                a transformed ancestor would shift its sticky containing block. */}
            <Projects />
          </section>
